 ...
 *
 * @see Wuro\Services\ClientsService::create()
 *
 * @phpstan-type ClientCreateParamsShape = array{
 *   name: string,
 *   address?: string|null,
 ...
 * }
 */
final class ClientCreateParams implements BaseModel
{
    /** @use SdkModel<ClientCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ClientCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ClientCreateParams::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ClientCreateParams)->withName(...)
     * ```
     */
