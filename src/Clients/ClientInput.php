...
/**
 * @phpstan-type ClientInputShape = array{
 *   name: string,
 *   address?: string|null,
 ...
 * }
 */
final class ClientInput implements BaseModel
{
    /** @use SdkModel<ClientInputShape> */
    use SdkModel;
    ...
    /**
     * `new ClientInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ClientInput::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ClientInput)->withName(...)
     * ```
     */
