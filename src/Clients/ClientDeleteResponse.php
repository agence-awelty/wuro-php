 ...
 *
 * @phpstan-type ClientDeleteResponseShape = array{
 *   client?: null|Client|ClientShape
 * }
 */
final class ClientDeleteResponse implements BaseModel
{
    /** @use SdkModel<ClientDeleteResponseShape> */
    use SdkModel;
