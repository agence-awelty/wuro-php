 ...
 *
 * @phpstan-type UserGetByUidResponseShape = array{user?: null|User|UserShape}
 */
final class UserGetByUidResponse implements BaseModel
{
    /** @use SdkModel<UserGetByUidResponseShape> */
    use SdkModel;
