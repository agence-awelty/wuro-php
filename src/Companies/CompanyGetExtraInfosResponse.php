 ...
 *
 * @phpstan-type CompanyGetExtraInfosResponseShape = array{
 *   company?: null|Company|CompanyShape,
 *   companyApp?: null|CompanyApp|CompanyAppShape,
 * }
 */
final class CompanyGetExtraInfosResponse implements BaseModel
{
    /** @use SdkModel<CompanyGetExtraInfosResponseShape> */
    use SdkModel;
