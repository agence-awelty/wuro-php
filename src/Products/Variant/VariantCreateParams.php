 ...
 *
 * @see Wuro\Services\Products\VariantService::create()
 *
 * @phpstan-import-type StockShape from \Wuro\Products\Variant\VariantCreateParams\Stock
 *
 * @phpstan-type VariantCreateParamsShape = array{
 ...
 * }
 */
final class VariantCreateParams implements BaseModel
{
    /** @use SdkModel<VariantCreateParamsShape> */
    use SdkModel;
    use SdkParams;
