...
use Wuro\Products\ProductInput\Option;
use Wuro\Products\ProductInput\Specifications;
use Wuro\Products\ProductInput\Stock;

/**
 * @phpstan-import-type OptionShape from \Wuro\Products\ProductInput\Option
 * @phpstan-import-type SpecificationsShape from \Wuro\Products\ProductInput\Specifications
 * @phpstan-import-type StockShape from \Wuro\Products\ProductInput\Stock
 *
 * @phpstan-type ProductInputShape = array{
 *   name: string,
 ...
 * }
 */
final class ProductInput implements BaseModel
{
    /** @use SdkModel<ProductInputShape> */
    use SdkModel;
    ...
    /**
     * `new ProductInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProductInput::with(name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ProductInput)->withName(...)
     * ```
     */
