 ...
 *
 * @phpstan-type PaymentMethodDeleteResponseShape = array{
 *   paymentMethod?: null|PaymentMethod|PaymentMethodShape
 * }
 */
final class PaymentMethodDeleteResponse implements BaseModel
{
    /** @use SdkModel<PaymentMethodDeleteResponseShape> */
    use SdkModel;
