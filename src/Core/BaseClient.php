...
use Wuro\Core\Contracts\BasePage;
use Wuro\Core\Contracts\BaseResponse;
use Wuro\Core\Contracts\BaseStream;
...
use Wuro\Core\Implementation\RawResponse;
...
abstract class BaseClient
{
    ...
    /** @return array<string,string> */
    abstract protected function appIDAuth(): array;

    /** @return array<string,string> */
    abstract protected function appSecretAuth(): array;
