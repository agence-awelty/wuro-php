 ...
 *
 * @phpstan-type QuoteNewProformaInvoiceResponseShape = array{
 *   newInvoice?: null|Invoice|InvoiceShape
 * }
 */
final class QuoteNewProformaInvoiceResponse implements BaseModel
{
    /** @use SdkModel<QuoteNewProformaInvoiceResponseShape> */
    use SdkModel;
