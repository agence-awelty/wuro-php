 ...
 *
 * @phpstan-type QuoteNewInvoiceFromQuoteResponseShape = array{
 *   newInvoice?: null|Invoice|InvoiceShape
 * }
 */
final class QuoteNewInvoiceFromQuoteResponse implements BaseModel
{
    /** @use SdkModel<QuoteNewInvoiceFromQuoteResponseShape> */
    use SdkModel;
