 ...
 *
 * @phpstan-type QuoteNewResponseShape = array{newQuote?: null|Quote|QuoteShape}
 */
final class QuoteNewResponse implements BaseModel
{
    /** @use SdkModel<QuoteNewResponseShape> */
    use SdkModel;
