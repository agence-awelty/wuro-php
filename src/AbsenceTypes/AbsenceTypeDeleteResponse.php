 ...
 *
 * @phpstan-type AbsenceTypeDeleteResponseShape = array{
 *   absenceType?: null|AbsenceType|AbsenceTypeShape
 * }
 */
final class AbsenceTypeDeleteResponse implements BaseModel
{
    /** @use SdkModel<AbsenceTypeDeleteResponseShape> */
    use SdkModel;
