 ...
 *
 * @phpstan-type DeliveryReceiptNewInvoiceResponseShape = array{
 *   newInvoice?: null|Invoice|InvoiceShape
 * }
 */
final class DeliveryReceiptNewInvoiceResponse implements BaseModel
{
    /** @use SdkModel<DeliveryReceiptNewInvoiceResponseShape> */
    use SdkModel;
