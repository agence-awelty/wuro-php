 ...
 *
 * @phpstan-type DeliveryReceiptDeleteResponseShape = array{
 *   receipt?: null|Receipt|ReceiptShape
 * }
 */
final class DeliveryReceiptDeleteResponse implements BaseModel
{
    /** @use SdkModel<DeliveryReceiptDeleteResponseShape> */
    use SdkModel;
